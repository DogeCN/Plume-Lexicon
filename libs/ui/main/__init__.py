...
class Ui_MainWindow:
    ...
    def setupUi(self, MainWindow:QMainWindow):
        ...
        self.actionClear.setShortcut(u"Ctrl+Shift+W")
        ...
        icon8 = QIcon(QIcon.fromTheme(u"emblem-important"))
        ...
        self.actionTool_Reload.setIcon(icon1)
        ...
        self.actionRemove.setShortcut(u"Ctrl+W")
        ...
        icon12 = QIcon(QIcon.fromTheme(u"emblem-favorite"))
